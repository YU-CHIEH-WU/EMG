...
app.service('dataService', function() {
    ...
    this.fameList = [{ 'title': '第一名', 'thumb': 'images/profile.jpg', 'name': '姜ＯＯ', 'slide': 'active', opacity: 'opacity' },
        { 'title': '第二名', 'thumb': 'images/profile.jpg', 'name': '王ＯＯ', 'slide': 'right', opacity: 'opacity' },
        { 'title': '第三名', 'thumb': 'images/profile.jpg', 'name': '鄧ＯＯ', 'slide': 'right', opacity: '' },
        { 'title': '第四名', 'thumb': 'images/profile.jpg', 'name': '張ＯＯ', 'slide': 'right', opacity: '' },
        { 'title': '第五名', 'thumb': 'images/profile.jpg', 'name': '吳ＯＯ', 'slide': 'right', opacity: '' }
    ];

});
app.controller('blockController', ['$scope', '$sce', '$http', '$timeout', '$interval', 'dataService', function($scope, $sce, $http, $timeout, $interval, dataService) {
    // 轉html標籤方法
    ...
    // 首頁
    // 首頁-最新消息
    $scope.newsList = dataService.newsList;
    // 首頁-名人榜
    $scope.fameList = dataService.fameList;
    var fameCount = 1;
    $interval(function() {
        if (fameCount == 0) {
    ...
    $scope.showDetail3 = function() {
        ...
        $scope.albumList = [];
        var getRankApi = 'http://163.17.135.185/EMG/Api/AlbumApi/GetRank';
